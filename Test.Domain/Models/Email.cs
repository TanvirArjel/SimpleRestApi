...
public sealed class Email : ValueObject
{
    ...
    private void SetValue(string value)
    {
        ...
        {
            throw new ArgumentException($"The Email length must be less than {_maxLength + 1} characters.");
        }
        ...
        {
            throw new ArgumentException("The Email value is not a valid email.");
        }
